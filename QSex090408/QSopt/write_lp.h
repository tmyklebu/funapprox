...
extern void ILLwrite_lp_state_init (ILLwrite_lp_state * line,
																		const char *str);
extern void ILLwrite_lp_state_append (ILLwrite_lp_state * line,
																			const char *str);
extern void ILLwrite_lp_state_append_coef (ILLwrite_lp_state * line,
			 ...
			 */
extern void ILLwrite_lp_state_append_number (ILLwrite_lp_state * line,
																						 EGlpNum_t v);
