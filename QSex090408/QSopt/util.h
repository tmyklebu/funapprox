...
extern int ILLutil_array_index (char *list[],
																int n,
																const char *name);
	 /* returns index of name in list or -1  */

extern int ILLutil_index (const char *list[],
													const char *name);
	 /* returns index of name in list or -1  */

extern unsigned int ILLutil_nextprime (unsigned int x);

extern const char *ILLutil_strchr (const char *s,
																	 int c);

extern int ILLutil_strcasecmp (const char *s1,
															 const char *s2);
extern int ILLutil_strncasecmp (const char *s1,
																const char *s2,
																size_t n);


extern int ILLutil_our_gcd (int a,
														int b),
  ILLutil_our_lcm (int a,
									 int b),
