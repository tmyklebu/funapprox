...
#undef _XOPEN_SOURCE           /* To handle problem with SUN Solaris 9 */
#include <sys/time.h>
#include <time.h>
#define _XOPEN_SOURCE 600      /* To handle problem with SUN Solaris 9 */
...
static void ILL_print (ILLutil_timer * t, double z, int printit)
{
