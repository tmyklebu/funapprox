...
double ILLutil_norm_sqr (double *v,
												 int len)
{
	int i;
	double sum = 0.0;
...
const char *ILLutil_strchr (const char *s,
														int c)
{
	while (*s)
	{
...
int ILLutil_strcasecmp (const char *s1,
												const char *s2)
{
	return strcasecmp (s1, s2);
}

int ILLutil_strncasecmp (const char *s1,
												 const char *s2,
												 size_t n)
{
...
int ILLutil_index (const char *list[],
									 const char *name)
{
	int i;
...
int ILLutil_array_index (char *list[],
												 int n,
												 const char *name)
{
	int i;
...
char *ILLutil_str (const char *str)
{
	int len;
	char *cpy = NULL;
	if (str != NULL)
