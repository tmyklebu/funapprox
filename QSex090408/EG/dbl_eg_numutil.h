 ...
 * */
#define dbl_EGlpNumInnProd(rop,arr1,arr2,length) dbl___EGlpNumInnProd(&(rop),arr1,arr2,length)
/* ========================================================================= */
/* internal version, this is done to avoid using stdc99 and rely on
 * more basic stdc89 */
void dbl___EGlpNumInnProd(double*const rop,double*const arr1,double*const arr2, const size_t length);
/* ========================================================================= */
