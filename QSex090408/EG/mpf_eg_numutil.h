 ...
 * */
/*
 * This file provide the user interface and function definitions for
 ...
 * */
#define mpf_EGlpNumInnProd(rop,arr1,arr2,length) mpf___EGlpNumInnProd(&(rop),arr1,arr2,length)
/* ========================================================================= */
/** internal version, this is done to avoid using stdc99 and rely on
 * more basic stdc89 */
void mpf___EGlpNumInnProd(mpf_t*const rop,mpf_t*const arr1,mpf_t*const arr2, const size_t length);
/* ========================================================================= */
 ...
 * This code is based in concorde's implementation of
