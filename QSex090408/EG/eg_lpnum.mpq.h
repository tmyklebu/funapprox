...
extern mpq_t __zeroLpNum_mpq__;
extern mpq_t __oneLpNum_mpq__;
extern mpq_t __lpnum_mpq__;
...
#define mpq_EGlpNumIsSumLess(a, b, c) ({\
	mpq_add (__lpnum_mpq__, a, b);\
	(mpq_cmp (__lpnum_mpq__, c) < 0);\
})
...
#define mpq_EGlpNumCopyDiffRatio(a, b, c, d) ({\
	mpq_sub (__lpnum_mpq__, b, c);\
	mpq_div (a, __lpnum_mpq__, d);\
})
...
#define mpq_EGlpNumSetToMaxAbs(dest, orig) ({\
	mpq_abs (__lpnum_mpq__, orig);\
	if (mpq_cmp (dest, __lpnum_mpq__) < 0)\
		mpq_set (dest, __lpnum_mpq__);\
})
...
#define mpq_EGlpNumCopySqrOver(dest, orig, den) ({\
	mpq_mul (__lpnum_mpq__, orig, orig);\
	mpq_div (dest, __lpnum_mpq__, den);\
})
...
#define mpq_EGlpNumSubInnProdTo(a, b, c) ({\
	mpq_mul (__lpnum_mpq__, b, c);\
	mpq_sub (a, a, __lpnum_mpq__);\
})
...
/* ========================================================================= */
/** This are the definitions needed to use mpq_t numbers within our general
 * framework @{ */
#if EGLPNUM_TYPE==GNU_MP_Q
#ifndef EGLPNUM_MAXCONVORDER
#define EGLPNUM_MAXCONVORDER 2U
#endif
#define EGLPNUM_ISFP 0
#define epsLpNum 													mpq_epsLpNum
#define oneLpNum 													mpq_oneLpNum
#define zeroLpNum 												mpq_zeroLpNum
#define EGlpNum_t 												mpq_t
#define EGlpNumAddTo(a,b)									mpq_EGlpNumAddTo(a,b)
#define EGlpNumAddUiTo(a,b) 							mpq_EGlpNumAddUiTo(a,b)
#define EGlpNumAddInnProdTo(a, b, c) 			mpq_EGlpNumAddInnProdTo(a,b,c)
#define EGlpNumAllocArray(size) 					mpq_EGlpNumAllocArray(size)
#define EGlpNumCeil(a, b) 								mpq_EGlpNumCeil(a,b)
#define EGlpNumClearVar(a) 								mpq_EGlpNumClearVar(a)
#define EGlpNumCopy(dest,orig) 						mpq_EGlpNumCopy(dest,orig)
#define EGlpNumCopyArray(dest,orig,size) 	mpq_EGlpNumCopyArray(dest,orig,size)
#define EGlpNumCopyDiff(dest,a,b) 				mpq_EGlpNumCopyDiff(dest,a,b)
#define EGlpNumCopyDiffRatio(a, b, c, d) 	mpq_EGlpNumCopyDiffRatio(a,b,c,d)
#define EGlpNumCopySum(dest,a,b) 					mpq_EGlpNumCopySum(dest,a,b)
#define EGlpNumCopySqrOver(dest,orig,den) mpq_EGlpNumCopySqrOver(dest,orig,den)
#define EGlpNumCopyAbs(dest,orig) 				mpq_EGlpNumCopyAbs(dest,orig)
#define EGlpNumCopyNeg(dest,orig) 				mpq_EGlpNumCopyNeg(dest,orig)
#define EGlpNumCopyFrac(dest,op1,op2) 		mpq_EGlpNumCopyFrac(dest,op1,op2)
#define EGlpNumDivTo(a,b) 								mpq_EGlpNumDivTo(a,b)
#define EGlpNumDivUiTo(a,b) 							mpq_EGlpNumDivUiTo(a,b)
#define EGlpNumFloor(a, b) 								mpq_EGlpNumFloor(a,b)
#define EGlpNumFreeArray(ea) 							mpq_EGlpNumFreeArray(ea)
#define EGlpNumGetStr(a) 									mpq_EGlpNumGetStr(a)
#define EGlpNumInitVar(a) 								mpq_EGlpNumInitVar(a)
#define EGlpNumInv(a) 										mpq_EGlpNumInv(a,b)
#define EGlpNumIsDiffLess(a, b, c) 				mpq_EGlpNumIsDiffLess(a,b,c)
#define EGlpNumIsEqqual(a,b) 							mpq_EGlpNumIsEqqual(a,b)
#define EGlpNumIsEqual(a,b,error) 				mpq_EGlpNumIsEqual(a,b,error)
#define EGlpNumIsGreaDbl(a,b) 						mpq_EGlpNumIsGreaDbl(a,b)
#define EGlpNumIsLessDbl(a,b) 						mpq_EGlpNumIsLessDbl(a,b)
#define EGlpNumIsLess(a,b) 								mpq_EGlpNumIsLess(a,b)
#define EGlpNumIsLeq(a,b) 								mpq_EGlpNumIsLeq(a,b)
#define EGlpNumIsNeq(a,b,error)   				mpq_EGlpNumIsNeq(a,b)
#define EGlpNumIsNeqq(a,b)        				mpq_EGlpNumIsNeqq(a,b)
#define EGlpNumIsNeqZero(a,error) 				mpq_EGlpNumIsNeqZero(a,b)
#define EGlpNumIsNeqqZero(a)      				mpq_EGlpNumIsNeqqZero(a)
#define EGlpNumIsSumLess(a, b, c) 				mpq_EGlpNumIsSumLess(a,b,c)
#define EGlpNumMultTo(a,b) 								mpq_EGlpNumMultTo(a,b)
#define EGlpNumMultUiTo(a,b) 							mpq_EGlpNumMultUiTo(a,b)
#define EGlpNumOne(a) 										mpq_EGlpNumOne(a)
#define EGlpNumReadStr(a,str) 						mpq_EGlpNumReadStrXc(a,str)
#define EGlpNumReallocArray(lptr,size) 		mpq_EGlpNumReallocArray(lptr,size)
#define EGlpNumSet(var,dbl) 							mpq_EGlpNumSet(var,dbl)
#define EGlpNumSetToMaxAbs(dest, orig) 		mpq_EGlpNumSetToMaxAbs(dest,orig)
#define EGlpNumSetToMinAbs(dest, orig) 		mpq_EGlpNumSetToMinAbs(dest,orig)
#define EGlpNumSign(a) 										mpq_EGlpNumSign(a)
#define EGlpNumSubTo(a,b) 								mpq_EGlpNumSubTo(a,b)
#define EGlpNumSubUiTo(a,b) 							mpq_EGlpNumSubUiTo(a,b)
#define EGlpNumSubInnProdTo(a, b, c) 			mpq_EGlpNumSubInnProdTo(a,b,c)
#define EGlpNumToLf(a) 										mpq_EGlpNumToLf(a)
#define EGlpNumZero(a) 										mpq_EGlpNumZero(a)
#endif
